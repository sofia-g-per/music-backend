...
@ViewEntity({
   ...
   FROM normalized_song_listen_history_popularity_by_user
     LEFT JOIN median_normalized_listened_song_popularity_by_user median_values 
     ON median_values.user_id = normalized_song_listen_history_popularity_by_user.user_id
